...
setwd("C:/Users/gyedu/OneDrive/Desktop/Ludema Study")
nhanes_data <- read.csv("nhanes_2017_2018_cleaned.csv", header = TRUE)
...
columns_to_clean <- c("depression", "diabetes", "education", "snore","apnea_symptoms","daytime_sleepy","work_vigorous","work_moderate","hypertension")
